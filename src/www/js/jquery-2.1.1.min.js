...
!function(a, b) {
  ...
  var c = [], d = c.slice, e = c.concat, f = c.push, g = c.indexOf, h = {}, i = h.toString,
      j = h.hasOwnProperty, k = {}, l = a.document, m = '2.1.1',
      n =
          function(a, b) {
  ...
  n.extend({
    ...
    globalEval: function(a) {
      ...
      a = n.trim(a),
      a &&
          (1 === a.indexOf('use strict') ? (b = l.createElement('script'), b.text = a,
  ...
  var t = function(a) {
    var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t,
        u = 'sizzle' + -new Date, v = a.document, w = 0, x = 0, y = gb(), z = gb(), A = gb(),
        B =
            function(a, b) {
          return a === b && (l = !0), 0
        },
          ...
          if (j = f[1]) {
            if (9 === k) {
              ...
              if (h.id === j) return d.push(h), d
                ...
                b.ownerDocument && (h = b.ownerDocument.getElementById(j)) && t(b, h) && h.id === j)
              return d.push(h), d
          } else {
    ...
    function wb(a) {
      for (var b, c, e,
           f = a.length, g = d.relative[a[0].type], h = g || d.relative[' '], i = g ? 1 : 0,
           k = rb(
               function(a) {
                 return a === b
               },
        ...
        if (c = d.relative[a[i].type])
          ...
          if (c = d.filter[a[i].type].apply(null, a[i].matches), c[u]) {
            ...
            return vb(
                i > 1 && sb(m), i > 1 && qb(a.slice(0, i - 1).concat({
                                           value: ' ' === a[i - 2].type ? '*' : ''
                                         })).replace(R, '$1'),
                c, e > i && wb(a.slice(i, e)), f > e && wb(a = a.slice(e)), f > e && qb(a))
          }
          m.push(c)
        }
      return sb(m)
           ...
           i = fb.select =
             ...
             if (e = e || [], 1 === o.length) {
               if (j = o[0] = o[0].slice(0),
                   j.length > 2 && 'ID' === (k = j[0]).type && c.getById && 9 === b.nodeType && p &&
                       d.relative[j[1].type]) {
  ...
  n.filter = function(a, b, c) {
    var d = b[0];
    return c && (a = ':not(' + a + ')'),
           1 === b.length && 1 === d.nodeType ? n.find.matchesSelector(d, a) ? [d] : [] :
  ...
  n.ready.promise = function(b) {
    return H ||
               (H = n.Deferred(),
                'complete' === l.readyState ? setTimeout(n.ready) :
    ...
    _removeData: function(a, b) {
      ...
      n.extend({
        queue: function(a, b, c) {
          var d;
          return a ? (b = (b || 'fx') + 'queue', d = L.get(a, b),
    ...
    add: function(a, b, c, d, e) {
      ...
      if (r) {
        ...
        while (j--)
          ...
          o &&
              (l = n.event.special[o] || {}, o = (e ? l.delegateType : l.bindType) || o,
               l = n.event.special[o] || {},
               k = n.extend(
                   {
                     type: o,
               ...
               e ? m.splice(m.delegateCount++, 0, k) : m.push(k), n.event.global[o] = !0)
      }
    },
      ...
      if (r && (i = r.events)) {
        ...
        while (j--)
          if (h = Y.exec(b[j]) || [], o = q = h[1], p = (h[2] || '').split('.').sort(), o) {
            ...
            m = i[o] || [], h = h[2] && new RegExp('(^|\\.)' + p.join('\\.(?:.*\\.|)') + '(\\.|$)'),
            g = f = m.length;
            while (f--)
              k = m[f],
              !e && q !== k.origType || c && c.guid !== k.guid || h && !h.test(k.namespace) ||
      ...
      if (g = h = d = d || l,
          3 !== d.nodeType && 8 !== d.nodeType && !X.test(q + n.event.triggered) &&
              (q.indexOf('.') >= 0 && (r = q.split('.'), q = r.shift(), r.sort()),
               ...
               b.namespace_re =
                   b.namespace ? new RegExp('(^|\\.)' + r.join('\\.(?:.*\\.|)') + '(\\.|$)') : null,
               b.result = void 0, b.target || (b.target = d),
               c = null == c ? [b] : n.makeArray(c, [b]), o = n.event.special[q] || {},
        ...
        return b.type = q,
               e || b.isDefaultPrevented() || o._default && o._default.apply(p.pop(), c) !== !1 ||
                   !n.acceptData(d) ||
        ...
        for (; i !== this; i = i.parentNode || this)
          if (i.disabled !== !0 || 'click' !== a.type) {
            for (d = [], c = 0; h > c; c++)
              f = b[c], e = f.selector + ' ',
              void 0 === d[e] &&
                  (d[e] = f.needsContext ? n(e, this).index(i) >= 0 :
    ...
    mouseHooks: {
      ...
      filter: function(a, b) {
        ...
        return null == a.pageX && null != b.clientX &&
                   (c = a.target.ownerDocument || l, d = c.documentElement, e = c.body,
                    a.pageX = b.clientX + (d && d.scrollLeft || e && e.scrollLeft || 0) -
             ...
             (this.originalEvent = a, this.type = a.type,
              this.isDefaultPrevented =
                  a.defaultPrevented || void 0 === a.defaultPrevented && a.returnValue === !1 ? Z :
                                                                                                $) :
             this.type = a,
         b && n.extend(this, b), this.timeStamp = a && a.timeStamp || n.now(),
    ...
    off: function(a, b, c) {
      ...
      if (a && a.preventDefault && a.handleObj)
        return d = a.handleObj,
               n(a.delegateTarget)
                   .off(
                       d.namespace ? d.origType + '.' + d.namespace : d.origType, d.selector,
                       d.handler),
               this;
      if ('object' == typeof a) {
  ...
  n.extend({
    ...
    buildFragment: function(a, b, c, d) {
      for (var e, f, g, h, i, j, k = b.createDocumentFragment(), l = [], m = 0, o = a.length; o > m;
           m++)
        if (e = a[m], e || 0 === e)
          if ('object' === n.type(e))
            ...
            g = (bb.exec(e) || ['', ''])[1].toLowerCase(), h = ib[g] || ib._default,
      ...
      while (e = l[m++])
        if ((!d || -1 === n.inArray(e, d)) &&
            (i = n.contains(e.ownerDocument, e), f = ob(k.appendChild(e), 'script'), i && mb(f),
             c)) {
          j = 0;
    ...
    cleanData: function(a) {
      ...
      n.fn.extend({
        ...
        domManip: function(a, b) {
          ...
          if (l &&
              (c = n.buildFragment(a, this[0].ownerDocument, !1, this), d = c.firstChild,
               1 === c.childNodes.length && (c = d), d)) {
            for (f = n.map(ob(c, 'script'), kb), g = f.length; l > j; j++)
              h = c, j !== o && (h = n.clone(h, !0, !0), g && n.merge(f, ob(h, 'script'))),
              b.call(this[j], h, j);
            if (g)
  ...
  function Jb(a, b) {
    for (var c, d, e, f = [], g = 0, h = a.length; h > g; g++)
      d = a[g],
      d.style &&
          (f[g] = L.get(d, 'olddisplay'), c = d.style.display,
  ...
  n.extend({
    ...
    css: function(a, b, c, d) {
      ...
      return b = n.cssProps[h] || (n.cssProps[h] = Fb(a.style, h)),
             g = n.cssHooks[b] || n.cssHooks[h], g && 'get' in g && (e = g.get(a, !0, c)),
             void 0 === e && (e = xb(a, b, d)), 'normal' === e && b in Db && (e = Db[b]),
  ...
  function Vb(a, b, c) {
    ...
    c.queue ||
        ...
        (c.overflow = [o.overflow, o.overflowX, o.overflowY], j = n.css(a, 'display'),
    ...
    removeAttr: function(a) {
            ...
            return typeof a.getAttribute === U ?
                ...
                (1 === f && n.isXMLDoc(a) ||
                 ...
                 void 0 === c ? d && 'get' in d && null !== (e = d.get(a, b)) ?
                                ...
                                null !== c ? d && 'set' in d && void 0 !== (e = d.set(a, c, b)) ?
                                             e :
      ...
      n.each(n.expr.match.bool.source.match(/\w+/g), function(a, b) {
        ...
        $b[b] = function(a, b, d) {
          var e, f;
          return d ||
                     (f = $b[b], $b[b] = e, e = null != c(a, b, d) ? b.toLowerCase() : null,
                      $b[b] = f),
                 e
        }
      });
  ...
  n.extend({
    ...
    ajax: function(a, b) {
      ...
      if (o.promise(v).complete = p.add, v.success = v.done, v.error = v.fail,
          ...
          sc(nc, k, b, v), 2 === t)
        return v;
      i = k.global, i && 0 === n.active++ && n.event.trigger('ajaxStart'),
      k.type = k.type.toUpperCase(), k.hasContent = !kc.test(k.type), d = k.url,
      k.hasContent ||
          (k.data && (d = k.url += (dc.test(d) ? '&' : '?') + k.data, delete k.data),
           k.cache === !1 &&
               (k.url = hc.test(d) ? d.replace(hc, '$1_=' + cc++) :
                                     d + (dc.test(d) ? '&' : '?') + '_=' + cc++)),
      k.ifModified &&
      ...
      function x(a, b, f, h) {
        var j, r, s, u, w, x = b;
        2 !== t &&
            (t = 2, g && clearTimeout(g), c = void 0, e = h || '', v.readyState = a > 0 ? 4 : 0,
             j = a >= 200 && 300 > a || 304 === a, f && (u = uc(k, v, f)), u = vc(k, u, v, j),
             j ? (k.ifModified &&
                      (w = v.getResponseHeader('Last-Modified'), w && (n.lastModified[d] = w),
                       w = v.getResponseHeader('etag'), w && (n.etag[d] = w)),
                  204 === a || 'HEAD' === k.type ?
                      x = 'nocontent' :
                      304 === a ? x = 'notmodified' :
             ...
             j ? o.resolveWith(l, [r, x, v]) : o.rejectWith(l, [v, x, s]), v.statusCode(q),
             q = void 0, i && m.trigger(j ? 'ajaxSuccess' : 'ajaxError', [v, k, j ? r : s]),
             p.fireWith(l, [v, x]),
                ...
                b &&
                    (delete Dc[g], b = f.onload = f.onerror = null,
                     'abort' === a ?
                         ...
                         d(Ec[f.status] || f.status, f.statusText,
      ...
      n.ajaxPrefilter('json jsonp', function(b, c, d) {
        ...
        return h || 'jsonp' === b.dataTypes[0] ?
            (e = b.jsonpCallback =
             ...
             d.always(function() {
               a[e] = f, b[e] && (b.jsonpCallback = c.jsonpCallback, Gc.push(e)),
        ...
        return d ? [b.createElement(d[1])] :
                   (d = n.buildFragment([a], b, e), e && e.length && n(e).remove(),
