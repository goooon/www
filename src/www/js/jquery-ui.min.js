 ...
 * jquery.ui.effect.js, jquery.ui.accordion.js, jquery.ui.autocomplete.js, jquery.ui.button.js,
 ...
 * jquery.ui.spinner.js, jquery.ui.tabs.js, jquery.ui.tooltip.js Copyright 2014 jQuery Foundation
  ...
  return 'area' === r ?
      (n = e.parentNode, o = n.name,
       e.href && o && 'map' === n.nodeName.toLowerCase() ?
           ...
           !1) :
      (/input|select|textarea|button|object/.test(r) ? !e.disabled : 'a' === r ? e.href || i : i) &&
          s(e)
}
function s(e) {
    ...
    t.fn.extend({
      ...
      scrollParent: function() {
        ...
        return e = t.ui.ie && /(static|relative)/.test(this.css('position')) ||
                   ...
                   this.parents()
                       .filter(function() {
                         return /(relative|absolute|fixed)/.test(t.css(this, 'position')) &&
                             /(auto|scroll)/.test(
                                 t.css(this, 'overflow') + t.css(this, 'overflow-y') +
  ...
  n(e)
          ...
          function(i, n) {
            return t.isFunction(n) ? (l[i] = function() {
              ...
              return function() {
                ...
                return this._super = t, this._superApply = e, i = n.apply(this, arguments),
    ...
    t.each({show: 'fadeIn', hide: 'fadeOut'}, function(e, i) {
      t.Widget.prototype['_' + e] = function(s, n, o) {
        ...
        n = n || {}, 'number' == typeof n && (n = {duration: n}), a = !t.isEmptyObject(n),
        n.complete = o, n.delay && s.delay(n.delay),
        a && t.effects && t.effects.effect[r] ?
            s[e](n) :
            r !== e && s[r] ? s[r](n.duration, n.easing, o) : s.queue(function(i) {
...
t.widget('ui.draggable', t.ui.mouse, {
  ...
  _create: function() {
    'original' !== this.options.helper || /^(?:r|a|f)/.test(this.element.css('position')) ||
        ...
        this.options.disabled && this.element.addClass('ui-draggable-disabled'), this._mouseInit()
  },
  _destroy: function() {
  ...
  _mouseStart: function(e) {
    ...
    return this.helper = this._createHelper(e), this.helper.addClass('ui-draggable-dragging'),
           ...
           i.cursorAt && this._adjustOffsetFromHelper(i.cursorAt), this._setContainment(),
    ...
    return t.ui.ddmanager && !this.options.dropBehaviour && (s = t.ui.ddmanager.drop(this, e)),
           ...
           'original' !== this.options.helper ||
               ...
               ('invalid' === this.options.revert && !s || 'valid' === this.options.revert && s ||
                    ...
                    t(this.helper)
                        .animate(
                            this.originalPosition, parseInt(this.options.revertDuration, 10),
                            function() {
    ...
    return n.containment ?
        ...
        (this.containment =
             [
               ...
               t(window).scrollLeft() + t(window).width() - this.helperProportions.width -
                   this.margins.left,
               t(window).scrollTop() +
  ...
  _convertPositionTo: function(e, i) {
    ...
    var s = 'absolute' === e ? 1 : -1,
        ...
        this.scrollParent :
        this.offsetParent;
    return this.offset.scroll || (this.offset.scroll = {top: n.scrollTop(), left: n.scrollLeft()}),
    {
  ...
  _generatePosition: function(e) {
    var i, s, n, o, a = this.options,
        ...
        this.offsetParent,
                    h = e.pageX, l = e.pageY;
    return this.offset.scroll || (this.offset.scroll = {top: r.scrollTop(), left: r.scrollLeft()}),
               ...
               (this.containment &&
                    (this.relative_container ?
                         (s = this.relative_container.offset(),
                          i =
                              [
                                this.containment[0] + s.left, this.containment[1] + s.top,
                ...
                a.grid &&
                    (n = a.grid[1] ? this.originalPageY +
                             Math.round((l - this.originalPageY) / a.grid[1]) * a.grid[1] :
                                     this.originalPageY,
                     l = i ? n - this.offset.click.top >= i[1] || n - this.offset.click.top > i[3] ?
                             n :
  ...
  _uiHash: function() {
    ...
    t.ui.plugin.add('draggable', 'snap', {
      start: function() {
        ...
        e.snapElements = [],
        t(i.snap.constructor !== String ? i.snap.items || ':data(ui-draggable)' : i.snap)
            .each(function() {
      ...
      drag: function(e, i) {
        var s, n, o, a, r, h, l, c, u, d,
            p = t(this).data('ui-draggable'), f = p.options, g = f.snapTolerance, m = i.offset.left,
            v = m + p.helperProportions.width, _ = i.offset.top, b = _ + p.helperProportions.height;
          ...
          r - g > v || m > h + g || l - g > b || _ > c + g ||
              ...
              (p.snapElements[u].snapping && p.options.snap.release &&
                   p.options.snap.release.call(
                       p.element, e, t.extend(p._uiHash(), {snapItem: p.snapElements[u].item})),
               p.snapElements[u].snapping = !1) :
              ('inner' !== f.snapMode &&
                   (s = g >= Math.abs(l - b), n = g >= Math.abs(c - _), o = g >= Math.abs(r - v),
                    a = g >= Math.abs(h - m),
                    s &&
                        (i.position.top = p._convertPositionTo('relative', {
                             ...
                             p.margins.top),
                    n &&
                        (i.position.top = p._convertPositionTo('relative', {top: c, left: 0}).top -
                             p.margins.top),
                    o &&
               ...
               d = s || n || o || a,
               'outer' !== f.snapMode &&
                   (s = g >= Math.abs(l - _), n = g >= Math.abs(c - b), o = g >= Math.abs(r - m),
                    a = g >= Math.abs(h - v),
                    s &&
                        (i.position.top = p._convertPositionTo('relative', {top: l, left: 0}).top -
                             p.margins.top),
                    n &&
                        (i.position.top = p._convertPositionTo('relative', {
    ...
    t.ui.plugin.add('draggable', 'stack', {
      start: function() {
        ...
        s.length &&
            (e = parseInt(t(s[0]).css('zIndex'), 10) || 0, t(s).each(function(i) {
...
t.widget('ui.droppable', {
  ...
  _drop: function(e, i) {
    ...
    return s && (s.currentItem || s.element)[0] !== this.element[0] ?
        (this.element.find(':data(ui-droppable)').not('.ui-draggable-dragging').each(function() {
          ...
          return e.options.greedy && !e.options.disabled && e.options.scope === s.options.scope &&
                  e.accept.call(e.element[0], s.currentItem || s.element) &&
                  t.ui.intersect(
                      s, t.extend(e, {offset: e.element.offset()}), e.options.tolerance) ?
              (n = !0, !1) :
              undefined
        }),
         n ? !1 :
  ...
  ui: function(t) {
    return {
      draggable: t.currentItem || t.element, helper: t.helper, position: t.position,
    ...
    t.ui.intersect = function(t, i, s) {
      ...
      var n, o, a = (t.positionAbs || t.position.absolute).left,
                r = (t.positionAbs || t.position.absolute).top, h = a + t.helperProportions.width,
                l = r + t.helperProportions.height, c = i.offset.left, u = i.offset.top,
                d = c + i.proportions().width, p = u + i.proportions().height;
      switch (s) {
        case 'fit':
          return a >= c && d >= h && r >= u && p >= l;
        case 'intersect':
          return a + t.helperProportions.width / 2 > c && d > h - t.helperProportions.width / 2 &&
              r + t.helperProportions.height / 2 > u && p > l - t.helperProportions.height / 2;
        case 'pointer':
...
t.widget('ui.resizable', t.ui.mouse, {
    ...
    if (this.element.addClass('ui-resizable'), t.extend(this, {
        ...
        this.element[0].nodeName.match(/canvas|textarea|input|select|button|img/i) &&
            (this.element.wrap(
             ...
             this.element =
                 this.element.parent().data('ui-resizable', this.element.data('ui-resizable')),
      ...
      for ('all' === this.handles && (this.handles = 'n,e,s,w,se,sw,ne,nw'),
        ...
        n = t('<div class=\'ui-resizable-handle ' + o + '\'></div>'), n.css({zIndex: r.zIndex}),
    ...
    return this.elementIsWrapper &&
               (i(this.element), e = this.element,
                this.originalElement
                    ...
                    .insertAfter(e),
                e.remove()),
           this.originalElement.css('resize', this.originalResizeStyle), i(this.originalElement),
           this
  },
  _mouseCapture: function(e) {
    var i, s, n = !1;
  ...
  _mouseStart: function(i) {
    ...
    return this.resizing = !0,
           ...
           this.offset = this.helper.offset(), this.position = {left: s, top: n},
  ...
  _mouseDrag: function(e) {
    var i, s = this.helper, n = {}, o = this.originalMousePosition, a = this.axis,
           r = this.position.top, h = this.position.left, l = this.size.width, c = this.size.height,
           u = e.pageX - o.left || 0, d = e.pageY - o.top || 0, p = this._change[a];
    return p ?
        (i = p.apply(this, [e, u, d]), this._updateVirtualBoundaries(e.shiftKey),
         (this._aspectRatio || e.shiftKey) && (i = this._updateRatio(i, e)),
         i = this._respectSize(i, e), this._updateCache(i), this._propagate('resize', e),
         ...
         this.size.height !== c && (n.height = this.size.height + 'px'), s.css(n),
  ...
  _updateVirtualBoundaries: function(t) {
    ...
    (this._aspectRatio || t) &&
        (e = a.minHeight * this.aspectRatio, n = a.minWidth / this.aspectRatio,
         ...
         e > a.minWidth && (a.minWidth = e), n > a.minHeight && (a.minHeight = n),
         a.maxWidth > s && (a.maxWidth = s), a.maxHeight > o && (a.maxHeight = o)),
    this._vBoundaries = a
  },
  ...
  _respectSize: function(t) {
    var e = this._vBoundaries, s = this.axis, n = i(t.width) && e.maxWidth && e.maxWidth < t.width,
        ...
        l = this.position.top + this.size.height, c = /sw|nw|w/.test(s), u = /nw|ne|n/.test(s);
    return a && (t.width = e.minWidth), r && (t.height = e.minHeight), n && (t.width = e.maxWidth),
           o && (t.height = e.maxHeight), a && c && (t.left = h - e.minWidth),
           n && c && (t.left = h - e.maxWidth), r && u && (t.top = l - e.minHeight),
      ...
      for (t = 0; this._proportionallyResizeElements.length > t; t++) {
        if (n = this._proportionallyResizeElements[t], !this.borderDif)
          for (this.borderDif = [],
              i =
                   [
                     n.css('borderTopWidth'), n.css('borderRightWidth'), n.css('borderBottomWidth'),
                     n.css('borderLeftWidth')
                   ],
              s =
                   [
                     n.css('paddingTop'), n.css('paddingRight'), n.css('paddingBottom'),
                     n.css('paddingLeft')
                   ],
              e = 0;
               i.length > e; e++)
  ...
  ui: function() {
    ...
    t.ui.plugin.add('resizable', 'containment', {
      start: function() {
        var i, s, n, o, a, r, h,
            l = t(this).data('ui-resizable'), c = l.options, u = l.element, d = c.containment,
            p = d instanceof t ? d.get(0) : /parent/.test(d) ? u.parent().get(0) : d;
        p &&
            (l.containerElement = t(p),
             /document/.test(d) || d === document ?
                 (l.containerOffset = {left: 0, top: 0}, l.containerPosition = {left: 0, top: 0},
                  l.parentData = {
                    element: t(document),
                    left: 0,
                    top: 0,
                 ...
                 (i = t(p), s = [], t(['Top', 'Right', 'Left', 'Bottom']).each(function(t, n) {
                  ...
                  l.containerOffset = i.offset(), l.containerPosition = i.position(),
            ...
            h = function(e, s) {
              t(e).each(function() {
                var e = t(this), n = t(this).data('ui-resizable-alsoresize'), o = {},
                    a = s && s.length ?
                    s :
                    e.parents(i.originalElement[0]).length ? ['width', 'height'] :
    ...
    t.ui.plugin.add('resizable', 'grid', {
      resize: function() {
        var e = t(this).data('ui-resizable'), i = e.options, s = e.size, n = e.originalSize,
            ...
            r = 'number' == typeof i.grid ? [i.grid, i.grid] : i.grid, h = r[0] || 1, l = r[1] || 1,
        ...
        /^(se|s|e)$/.test(a) ?
            ...
            (p - l > 0 ? (e.size.height = p, e.position.top = o.top - u) :
                         (e.size.height = l, e.position.top = o.top + n.height - l),
             d - h > 0 ? (e.size.width = d, e.position.left = o.left - c) :
...
t.widget('ui.selectable', t.ui.mouse, {
  ...
  _mouseStart: function(e) {
    ...
    this.options.disabled ||
        (this.selectees = t(s.filter, this.element[0]), this._trigger('start', e),
               ...
               i && i.element !== s.element[0] &&
                   ('touch' === n.tolerance ?
                    ...
                    l ? (i.selected && (i.$element.removeClass('ui-selected'), i.selected = !1),
                         ...
                         i.selecting ||
                             (i.$element.addClass('ui-selecting'), i.selecting = !0,
                              s._trigger('selecting', e, {selecting: i.element}))) :
                        (i.selecting &&
                             ((e.metaKey || e.ctrlKey) && i.startselected ?
                                  (i.$element.removeClass('ui-selecting'), i.selecting = !1,
                                   i.$element.addClass('ui-selected'), i.selected = !0) :
                                  (i.$element.removeClass('ui-selecting'), i.selecting = !1,
                                   i.startselected &&
...
t.widget('ui.sortable', t.ui.mouse, {
  ...
  _mouseStart: function(e, i, s) {
    ...
    if (this.currentContainer = this, this.refreshPositions(), this.helper = this._createHelper(e),
        ...
        a.cursor && 'auto' !== a.cursor &&
            (o = this.document.find('body'), this.storedCursor = o.css('cursor'),
  ...
  _mouseDrag: function(e) {
    ...
    for (this.position = this._generatePosition(e),
      ...
      if (s = this.items[i], n = s.item[0], o = this._intersectsWithPointer(s),
          o && s.instance === this.currentContainer && n !== this.currentItem[0] &&
  ...
  cancel: function() {
    ...
    return this.placeholder &&
               (this.placeholder[0].parentNode &&
                ...
                this.domPosition.prev ? t(this.domPosition.prev).after(this.currentItem) :
  ...
  _intersectsWith: function(t) {
    var e = this.positionAbs.left, i = e + this.helperProportions.width, s = this.positionAbs.top,
        n = s + this.helperProportions.height, o = t.left, a = o + t.width, r = t.top,
        h = r + t.height, l = this.offset.click.top, c = this.offset.click.left,
    ...
    return 'pointer' === this.options.tolerance || this.options.forcePointerForContainers ||
        ...
        p :
        e + this.helperProportions.width / 2 > o && a > i - this.helperProportions.width / 2 &&
  ...
  _intersectsWithPointer: function(t) {
    ...
    return n ?
        this.floating ? a && 'right' === a || 'down' === o ? 2 : 1 : o && ('down' === o ? 2 : 1) :
        !1
  },
      ...
      for (s = l.length - 1; s >= 0; s--)
        for (o = t(l[s]), n = o.length - 1; n >= 0; n--)
          a = t.data(o[n], this.widgetFullName), a && a !== this && !a.options.disabled && h.push([
            t.isFunction(a.options.items) ? a.options.items.call(a.element) :
    ...
    for (i = this.items.length - 1; i >= 0; i--)
      ...
      s.instance !== this.currentContainer && this.currentContainer &&
          ...
          (n = this.options.toleranceElement ? t(this.options.toleranceElement, s.item) : s.item,
           e || (s.width = n.outerWidth(), s.height = n.outerHeight()), o = n.offset(),
  ...
  _createPlaceholder: function(e) {
    ...
    s.placeholder && s.placeholder.constructor !== String || (i = s.placeholder, s.placeholder = {
      ...
      update: function(t, n) {
        ...
        e.currentItem.after(e.placeholder), s.placeholder.update(e, e.placeholder)
  },
    ...
    if (f)
      if (1 === this.containers.length)
        ...
        for (a = 1e4, r = null, p = f.floating || i(this.currentItem), h = p ? 'left' : 'top',
            l = p ? 'width' : 'height', c = this.positionAbs[h] + this.offset.click[h],
            o = this.items.length - 1;
             o >= 0; o--)
          t.contains(this.containers[g].element[0], this.items[o].item[0]) &&
              this.items[o].item[0] !== this.currentItem[0] &&
              (!p ||
               e(this.positionAbs.top + this.offset.click.top, this.items[o].top,
                 this.items[o].height)) &&
               ...
               (this.containment &&
                ...
                n.grid &&
                    (i = this.originalPageY +
                     ...
                     a = this.containment ? i - this.offset.click.top >= this.containment[1] &&
                     ...
                     o = this.containment ? s - this.offset.click.left >= this.containment[0] &&
  ...
  _rearrange: function(t, e, i, s) {
    i ? i[0].appendChild(this.placeholder[0]) :
        e.item[0].parentNode.insertBefore(
            this.placeholder[0], 'down' === this.direction ? e.item[0] : e.item[0].nextSibling),
  ...
  _uiHash: function(e) {
    var i = e || this;
    return {
      helper: i.helper, placeholder: i.placeholder || t([]), position: i.position,
...
t
  ...
  effect: {}
   ...
   function(t, e) {
     ...
     function s(i) {
       ...
       return i = i.toLowerCase(), f(h, function(t, o) {
                ...
                return h ? (a = s[l](h), s[c[l].cache] = a[c[l].cache], n = s._rgba = a._rgba, !1) :
                           e
         ...
         return a !== e && (n = [n, a, r, h], d = 'array'),
                'string' === d ?
                    ...
                    (f(c.rgba.props,
                     ...
                     this) :
                    'object' === d ? (n instanceof l ? f(c, function(t, e) {
   ...
   function() {
     function i(e) {
       var i, s,
           n = e.ownerDocument.defaultView ? e.ownerDocument.defaultView.getComputedStyle(e, null) :
                                             e.currentStyle,
           o = {};
           ...
           toggleClass: function(i) {
             return function(s, n, o, a, r) {
               return 'boolean' == typeof n || n === e ?
                   o ? t.effects.animateClass.call(this, n ? {add: s} : {remove: s}, o, a, r) :
   ...
   function() {
     function s(e, i, s, n) {
       return t.isPlainObject(e) && (i = e, e = e.effect),
              e = {effect: e}, null == i && (i = {}), t.isFunction(i) && (n = i, s = null, i = {}),
              ('number' == typeof i || t.fx.speeds[i]) && (n = s, s = i, i = {}),
              t.isFunction(s) && (n = s, s = null), i && t.extend(e, i), s = s || i.duration,
              e.duration = t.fx.off ?
                  0 :
                  'number' == typeof s ? s :
...
var e = 0, i = {}, s = {};
i
    .height = i.paddingTop = i.paddingBottom = i.borderTopWidth = i.borderBottomWidth = 'hide',
   ...
   t.widget('ui.accordion', {
     ...
     _getCreateEventData: function() {
       return {
         header: this.active, panel: this.active.length ? this.active.next() : t(),
     ...
     _keydown: function(e) {
       if (!e.altKey && !e.ctrlKey) {
         ...
         o &&
             (t(e.target).attr('tabIndex', -1), t(o).attr('tabIndex', 0), o.focus(),
              e.preventDefault())
       }
     },
       ...
       this.headers.attr('role', 'tab')
           .each(function(e) {
             ...
             s || (s = a + '-header-' + e, i.attr('id', s)),
                 o || (o = a + '-panel-' + e, n.attr('id', o)), i.attr('aria-controls', o),
     ...
     _setupEvents: function(e) {
       ...
       e &&
           ...
           this._on(this.headers.next(), {keydown: '_panelKeyDown'}), this._hoverable(this.headers),
     ...
     _eventHandler: function(e) {
       ...
       e.preventDefault(),
           o && !i.collapsible || this._trigger('beforeActivate', e, l) === !1 ||
           (i.active = a ? !1 : this.headers.index(n), this.active = o ? t() : n, this._toggle(l),
     ...
     _toggle: function(e) {
       ...
       this.prevShow.add(this.prevHide).stop(!0, !0),
           ...
           s.attr({'aria-hidden': 'true'}), s.prev().attr('aria-selected', 'false'),
...
t.widget('ui.autocomplete', {
  ...
  _create: function() {
    ...
    this.valueMethod = this.element[o || a ? 'val' : 'text'], this.isNewMenu = !0,
  ...
  _appendTo: function() {
    ...
    return e && (e = e.jquery || e.nodeType ? t(e) : this.document.find(e).eq(0)),
           e || (e = this.element.closest('.ui-front')), e.length || (e = this.document[0].body), e
  },
...
t.widget('ui.button', {
  ...
  _create: function() {
    ...
    var s = this, a = this.options, r = 'checkbox' === this.type || 'radio' === this.type,
        h = r ? '' : 'ui-state-active';
    null === a.label &&
        (a.label = 'input' === this.type ? this.buttonElement.val() : this.buttonElement.html()),
  ...
  _determineButtonType: function() {
    ...
    this.type = this.element.is('[type=checkbox]') ?
        'checkbox' :
        this.element.is('[type=radio]') ? 'radio' : this.element.is('input') ? 'input' : 'button',
  ...
  _setOption: function(t, e) {
    return this._super(t, e),
           'disabled' === t ? (this.element.prop('disabled', !!e),
                               e && this.buttonElement.removeClass('ui-state-focus'), undefined) :
                              (this._resetButton(), undefined)
  },
  refresh: function() {
    var e = this.element.is('input, button') ? this.element.is(':disabled') :
  ...
  _resetButton: function() {
    ...
    n.primary || n.secondary ?
        (this.options.text &&
             a.push('ui-button-text-icon' + (o ? 's' : n.primary ? '-primary' : '-secondary')),
         n.primary &&
...
t.extend(i.prototype, {
  ...
  _attachDatepicker: function(e, i) {
    ...
    e.id || (this.uuid += 1, e.id = 'dp' + this.uuid), o = this._newInst(t(e), n),
  ...
  _newInst: function(e, i) {
    ...
    return {
      id: n, input: e, selectedDay: 0, selectedMonth: 0, selectedYear: 0, drawMonth: 0, drawYear: 0,
          inline: i,
          dpDiv: i ?
  ...
  _attachments: function(e, i) {
    ...
    i.append && i.append.remove(),
        ...
        e.unbind('focus', this._showDatepicker), i.trigger && i.trigger.remove(),
  ...
  _inlineDatepicker: function(e, i) {
    ...
    s.hasClass(this.markerClassName) ||
        (s.addClass(this.markerClassName).append(i.dpDiv), t.data(e, a, i),
         ...
         this._updateAlternate(i), i.settings.disabled && this._disableDatepicker(e),
  ...
  _dialogDatepicker: function(e, i, s, o, r) {
    ...
    return p ||
               (this.uuid += 1, h = 'dp' + this.uuid,
                ...
                p = this._dialogInst = this._newInst(this._dialogInput, !1), p.settings = {},
                t.data(this._dialogInput[0], a, p)),
           n(p.settings, o || {}),
           i = i && i.constructor === Date ? this._formatDate(p, i) : i, this._dialogInput.val(i),
  ...
  _destroyDatepicker: function(e) {
    ...
    s.hasClass(this.markerClassName) &&
        (i = e.nodeName.toLowerCase(), t.removeData(e, a),
         'input' === i ?
             (n.append.remove(), n.trigger.remove(),
  ...
  _optionDatepicker: function(i, s, o) {
    ...
    return 2 === arguments.length && 'string' == typeof s ?
        'defaults' === s ? t.extend({}, t.datepicker._defaults) :
                           c ? 'all' === s ? t.extend({}, c.settings) : this._get(c, s) : null :
        (a = s || {}, 'string' == typeof s && (a = {}, a[s] = o),
         c &&
             (this._curInst === c && this._hideDatepicker(), r = this._getDateDatepicker(i, !0),
              h = this._getMinMaxDate(c, 'min'), l = this._getMinMaxDate(c, 'max'),
              n(c.settings, a),
              ...
              this._attachments(t(i), c), this._autoSize(c), this._setDate(c, r),
              this._updateAlternate(c), this._updateDatepicker(c)),
         e)
  },
  ...
  _doKeyUp: function(e) {
    ...
    if (s.input.val() !== s.lastVal) try {
        ...
        i &&
            (t.datepicker._setDateFromField(s), t.datepicker._updateAlternate(s),
    ...
    if (e = e.target || e,
      ...
      o !== !1 &&
          (n(i.settings, o), i.lastVal = null, t.datepicker._lastInput = e,
           t.datepicker._setDateFromField(i), t.datepicker._inDialog && (e.value = ''),
           t.datepicker._pos ||
           ...
           r = {left: t.datepicker._pos[0], top: t.datepicker._pos[1]}, t.datepicker._pos = null,
           i.dpDiv.empty(), i.dpDiv.css({position: 'absolute', display: 'block', top: '-1000px'}),
           ...
           i.inline ||
               (h = t.datepicker._get(i, 'showAnim'), l = t.datepicker._get(i, 'duration'),
                i.dpDiv.zIndex(t(e).zIndex() + 1), t.datepicker._datepickerShowing = !0,
            ...
            (i = this._get(r, 'showAnim'), s = this._get(r, 'duration'),
             ...
             t.effects && (t.effects.effect[i] || t.effects[i]) ?
                 ...
                 r.dpDiv['slideDown' === i ? 'slideUp' : 'fadeIn' === i ? 'fadeOut' : 'hide'](
                     i ? s : null, n),
             i || n(), this._datepickerShowing = !1, o = this._get(r, 'onClose'),
  ...
  _gotoToday: function(e) {
    ...
    this._get(n, 'gotoCurrent') && n.currentDay ?
        (n.selectedDay = n.currentDay, n.drawMonth = n.selectedMonth = n.currentMonth,
         n.drawYear = n.selectedYear = n.currentYear) :
        (i = new Date, n.selectedDay = i.getDate(), n.drawMonth = n.selectedMonth = i.getMonth(),
  ...
  _selectDay: function(e, i, s, n) {
    ...
    t(n).hasClass(this._unselectableClass) || this._isDisabledDatepicker(a[0]) ||
        (o = this._getInst(a[0]), o.selectedDay = o.currentDay = t('a', n).html(),
         o.selectedMonth = o.currentMonth = i, o.selectedYear = o.currentYear = s,
  ...
  _updateAlternate: function(e) {
    ...
    o &&
        (i = this._get(e, 'altFormat') || this._get(e, 'dateFormat'), s = this._getDate(e),
  ...
  parseDate: function(i, s, n) {
    ...
    var o, a, r, h,
        l = 0, c = (n ? n.shortYearCutoff : null) || this._defaults.shortYearCutoff,
        u = 'string' != typeof c ? c : (new Date).getFullYear() % 100 + parseInt(c, 10),
        d = (n ? n.dayNamesShort : null) || this._defaults.dayNamesShort,
        p = (n ? n.dayNames : null) || this._defaults.dayNames,
        f = (n ? n.monthNamesShort : null) || this._defaults.monthNamesShort,
        g = (n ? n.monthNames : null) || this._defaults.monthNames, m = -1, v = -1, _ = -1, b = -1,
        y = !1, w = function(t) {
      ...
      if (y)
        ...
        switch (i.charAt(o)) {
          ...
          case '@':
            ...
            break;
          case '!':
            h = new Date((x('!') - this._ticksTo1970) / 1e4), m = h.getFullYear(),
            v = h.getMonth() + 1, _ = h.getDate();
            break;
          case '\'':
            w('\'') ? D() : y = !0;
            break;
        ...
        o =
          ...
          try {
            return t.datepicker.parseDate(
                t.datepicker._get(e, 'dateFormat'), i, t.datepicker._getFormatConfig(e))
          } catch (s) {
          }
      ...
      var e = {
        ...
        selectDay: function() {
          return t.datepicker._selectDay(
                     s, +this.getAttribute('data-month'), +this.getAttribute('data-year'), this),
                 !1
        },
  ...
  _generateHTML: function(t) {
    var e, i, s, n, o, a, r, h, l, c, u, d, p, f, g, m, v, _, b, y, w, x, k, D, C, I, P, T, M, S, z,
        A, E, H, N, W, O, F, R,
        L = new Date,
        ...
        V = this._get(t, 'hideIfNoPrevNext'), K = this._get(t, 'navigationAsDateFormat'),
        q = this._getNumberOfMonths(t), U = this._get(t, 'showCurrentAtPos'),
        Q = this._get(t, 'stepMonths'), X = 1 !== q[0] || 1 !== q[1],
        $ = this._daylightSavingAdjust(
            t.currentDay ? new Date(t.currentYear, t.currentMonth, t.currentDay) :
                           new Date(9999, 9, 9)),
    ...
    for (
       ...
       i = K ?
            this.formatDate(
                i, this._daylightSavingAdjust(new Date(te, Z - Q, 1)), this._getFormatConfig(t)) :
            i,
       ...
       n = K ?
            this.formatDate(
                n, this._daylightSavingAdjust(new Date(te, Z + Q, 1)), this._getFormatConfig(t)) :
            n,
       ...
       u = this._get(t, 'showWeek'), d = this._get(t, 'dayNames'), p = this._get(t, 'dayNamesMin'),
       f = this._get(t, 'monthNames'), g = this._get(t, 'monthNamesShort'),
       m = this._get(t, 'beforeShowDay'), v = this._get(t, 'showOtherMonths'),
       _ = this._get(t, 'selectOtherMonths'), b = this._getDefaultDate(t), y = '', x = 0;
        q[0] > x; x++) {
      for (k = '', this.maxRows = 4, D = 0; q[1] > D; D++) {
        ...
        for (P += '<div class=\'ui-datepicker-header ui-widget-header ui-helper-clearfix' + I +
                 '\'>' + (/all|left/.test(I) && 0 === x ? Y ? o : s : '') +
                 (/all|right/.test(I) && 0 === x ? Y ? s : o : '') +
                 this._generateMonthYearHeader(t, Z, te, G, J, x > 0 || D > 0, f, g) +
             ...
             7 > w; w++)
          M = (w + c) % 7,
          T += '<th' + ((w + c + 6) % 7 >= 5 ? ' class=\'ui-datepicker-week-end\'' : '') + '>' +
        ...
        for (P += T + '</tr></thead><tbody>',
             ...
             z = (this._getFirstDayOfMonth(te, Z) - c + 7) % 7, A = Math.ceil((z + S) / 7),
             E = X ? this.maxRows > A ? this.maxRows : A : A, this.maxRows = E,
             H = this._daylightSavingAdjust(new Date(te, Z, 1 - z)), N = 0;
             E > N; N++) {
          for (P += '<tr>',
               W = u ? '<td class=\'ui-datepicker-week-col\'>' + this._get(t, 'calculateWeek')(H) +
                       '</td>' :
                       '',
               w = 0;
               7 > w; w++)
            ...
            W += '<td class=\'' + ((w + c + 6) % 7 >= 5 ? ' ui-datepicker-week-end' : '') +
                (F ? ' ui-datepicker-other-month' : '') +
                (H.getTime() === C.getTime() && Z === t.selectedMonth && t._keyEvent ||
                ...
                (F && !v ?
                     '' :
                     ' ' + O[1] + (H.getTime() === $.getTime() ? ' ' + this._currentClass : '') +
                ...
                '>' +
                (F && !v ? '&#xa0;' :
                           R ? '<span class=\'ui-state-default\'>' + H.getDate() + '</span>' :
                               '<a class=\'ui-state-default' +
                             (H.getTime() === j.getTime() ? ' ui-state-highlight' : '') +
                             (H.getTime() === $.getTime() ? ' ui-state-active' : '') +
                             (F ? ' ui-priority-secondary' : '') + '\' href=\'#\'>' + H.getDate() +
                             '</a>') +
                '</td>',
      ...
      if (t.yearshtml = '', o || !v)
        ...
        for (
           ...
           t.yearshtml +=
            ...
            g >= f; f++)
          t.yearshtml += '<option value=\'' + f + '\'' + (f === i ? ' selected=\'selected\'' : '') +
              '>' + f + '</option>';
  ...
  _isInRange: function(t, e) {
    var i, s, n = this._getMinMaxDate(t, 'min'), o = this._getMinMaxDate(t, 'max'), a = null,
              r = null, h = this._get(t, 'yearRange');
    return h &&
               (i = h.split(':'), s = (new Date).getFullYear(), a = parseInt(i[0], 10),
                r = parseInt(i[1], 10), i[0].match(/[+\-].*/) && (a += s),
                i[1].match(/[+\-].*/) && (r += s)),
  ...
  _formatDate: function(t, e, i, s) {
    ...
    var n = e ? 'object' == typeof e ? e : this._daylightSavingAdjust(new Date(s, i, e)) :
                this._daylightSavingAdjust(new Date(t.currentYear, t.currentMonth, t.currentDay));
...
t.widget('ui.dialog', {
  ...
  _create: function() {
    ...
    this.options.title = this.options.title || this.originalTitle, this._createWrapper(),
    this.element.show()
        .removeAttr('title')
  ...
  open: function() {
    ...
    return this._isOpen ?
        ...
        (this._isOpen = !0, this.opener = t(this.document[0].activeElement), this._size(),
  ...
  _createWrapper: function() {
    ...
    this._on(this.uiDialog, {
      keydown: function(e) {
        if (this.options.closeOnEscape && !e.isDefaultPrevented() && e.keyCode &&
           ...
           t.isEmptyObject(i) || t.isArray(i) && !i.length ?
               ...
               (t.each(
                    ...
                    function(i, s) {
                      ...
                      o = {icons: s.icons, text: s.showText}, delete s.icons, delete s.showText,
  ...
  _makeResizable: function() {
    function e(t) {
      return {
        originalPosition: t.originalPosition, originalSize: t.originalSize, position: t.position,
            size: t.size
      }
    }
  ...
  _setOption: function(t, e) {
    ...
    'dialogClass' === t && n.removeClass(this.options.dialogClass).addClass(e),
        'disabled' !== t &&
        (this._super(t, e), 'appendTo' === t && this.uiDialog.appendTo(this._appendTo()),
         'buttons' === t && this._createButtons(),
         'closeText' === t && this.uiDialogTitlebarClose.button({label: '' + e}),
         'draggable' === t &&
             (i = n.is(':data(ui-draggable)'), i && !e && n.draggable('destroy'),
              !i && e && this._makeDraggable()),
         'position' === t && this._position(),
         'resizable' === t &&
             (s = n.is(':data(ui-resizable)'), s && !e && n.resizable('destroy'),
    ...
    if (this.options.modal) {
      ...
      t.ui.dialog.overlayInstances || this._delay(function() {
        t.ui.dialog.overlayInstances && this.document.bind('focusin.dialog', function(s) {
          ...
          this.overlay =
              t('<div>').addClass('ui-widget-overlay ui-front').appendTo(this._appendTo()),
          this._on(this.overlay, {mousedown: '_keepFocus'}), t.ui.dialog.overlayInstances++
    }
  },
    ...
    t.ui.dialog.overlayInstances = 0, t.uiBackCompat !== !1 && t.widget('ui.dialog', t.ui.dialog, {
      _position: function() {
        ...
        i ? (('string' == typeof i || 'object' == typeof i && '0' in i) &&
                 (s = i.split ? i.split(' ') : [i[0], i[1]], 1 === s.length && (s[1] = s[0]),
                  t.each(
                      ['left', 'top'],
                      function(t, e) {
...
t.effects.effect.blind = function(s, n) {
  ...
  h.parent().is('.ui-effects-wrapper') ? t.effects.save(h.parent(), l) : t.effects.save(h, l),
      h.show(),
      o = t.effects.createWrapper(h).css({overflow: 'hidden'}), a = o[p](),
      r = parseFloat(o.css(f)) || 0, m[p] = v ? a : 0,
      g ||
...
t.effects.effect.bounce = function(e, i) {
  var s, n, o, a = t(this), r = ['position', 'top', 'bottom', 'left', 'right', 'height', 'width'],
               ...
               u = e.direction || 'up', d = e.distance, p = e.times || 5,
               f = 2 * p + (c || l ? 1 : 0), g = e.duration / f, m = e.easing,
               v = 'up' === u || 'down' === u ? 'top' : 'left', _ = 'up' === u || 'left' === u,
               b = a.queue(), y = b.length;
...
t.effects.effect.clip = function(e, i) {
  ...
  t.effects.save(a, r), a.show(),
      s = t.effects.createWrapper(a).css({overflow: 'hidden'}), n = 'IMG' === a[0].tagName ? s : a,
      o = n[d](), l && (n.css(d, 0), n.css(p, o / 2)), f[d] = l ? o : 0, f[p] = l ? 0 : o / 2,
      n.animate(f, {
        queue: !1,
        duration: e.duration,
        easing: e.easing,
...
t.effects.effect.drop = function(e, i) {
  ...
  t.effects.save(n, o), n.show(), t.effects.createWrapper(n),
      ...
      u[l] = (r ? 'pos' === c ? '+=' : '-=' : 'pos' === c ? '-=' : '+=') + s, n.animate(u, {
        queue: !1,
        duration: e.duration,
        easing: e.easing,
        complete: function() {
...
t.effects.effect.fold = function(e, i) {
  ...
  t.effects.save(o, a), o.show(),
      ...
      h && s.css(d ? {height: 0, width: c} : {height: c, width: 0}), m[f[0]] = h ? n[0] : c,
      v[f[1]] = h ? n[1] : 0, s.animate(m, g, e.easing).animate(v, g, e.easing, function() {
...
t.effects.effect.highlight = function(e, i) {
  ...
  'hide' === o && (a.opacity = 0), t.effects.save(s, n),
      s.show().css({backgroundImage: 'none', backgroundColor: e.color || '#ffff99'}).animate(a, {
        queue: !1,
        duration: e.duration,
        easing: e.easing,
        complete: function() {
...
t.effects.effect.puff = function(e, i) {
  ...
  'show' === p && a.show(),
      ...
      ('box' === g || 'both' === g) &&
      (o.from.y !== o.to.y &&
           (_ = _.concat(u), a.from = t.effects.setTransition(a, u, o.from.y, a.from),
            a.to = t.effects.setTransition(a, u, o.to.y, a.to)),
       o.from.x !== o.to.x &&
           (_ = _.concat(d), a.from = t.effects.setTransition(a, d, o.from.x, a.from),
            a.to = t.effects.setTransition(a, d, o.to.x, a.to))),
      ('content' === g || 'both' === g) && o.from.y !== o.to.y &&
      (_ = _.concat(c).concat(l), a.from = t.effects.setTransition(a, c, o.from.y, a.from),
       a.to = t.effects.setTransition(a, c, o.to.y, a.to)),
      t.effects.save(a, _), a.show(), t.effects.createWrapper(a),
      a.css('overflow', 'hidden').css(a.from),
      m &&
      (n = t.effects.getBaseline(m, s), a.from.top = (s.outerHeight - a.outerHeight()) * n.y,
      ...
      a.animate(a.to, {
        ...
        complete: function() {
          0 === a.to.opacity && a.css('opacity', a.from.opacity), 'hide' === p && a.hide(),
              ...
              f ||
              ('static' === v ? a.css({position: 'relative', top: a.to.top, left: a.to.left}) :
                                t.each(
                                    ['top', 'left'],
                                    function(t, e) {
...
t.widget('ui.menu', {
  ...
  focus: function(t, e) {
    ...
    this.blur(t, t && 'focus' === t.type), this._scrollIntoView(e),
        this.active = e.first(), s = this.active.children('a').addClass('ui-state-focus'),
        ...
        t && 'keydown' === t.type ? this._close() :
                                    this.timer = this._delay(
                                        ...
                                        this.delay),
        i = e.children('.ui-menu'), i.length && t && /^mouse/.test(t.type) && this._startOpening(i),
  ...
  _scrollIntoView: function(e) {
    ...
    this._hasScroll() &&
        (i = parseFloat(t.css(this.activeMenu[0], 'borderTopWidth')) || 0,
         ...
         a = this.activeMenu.height(), r = e.height(),
...
t.position = {
  ...
  getWithinInfo: function(e) {
    ...
    return {
      element: i, isWindow: s, isDocument: n, offset: i.offset() || {left: 0, top: 0},
          scrollLeft: i.scrollLeft(), scrollTop: i.scrollTop(),
          width: s ? i.width() : i.outerWidth(), height: s ? i.height() : i.outerHeight()
    }
  }
},
    t.fn.position =
      ...
      var o, p, g, m, v, _, b = t(e.of), y = t.position.getWithinInfo(e.within),
                            w = t.position.getScrollInfo(y), x = (e.collision || 'flip').split(' '),
                            k = {};
      return _ = n(b), b[0].preventDefault && (e.at = 'left top'), p = _.width, g = _.height,
             m = _.offset, v = t.extend({}, m),
             t.each(
                 ['my', 'at'],
                 function() {
                   ...
                   1 === s.length &&
                       ...
                       s[0] = l.test(s[0]) ? s[0] : 'center', s[1] = c.test(s[1]) ? s[1] : 'center',
                       t = u.exec(s[0]), i = u.exec(s[1]), k[this] = [t ? t[0] : 0, i ? i[0] : 0],
             ...
             o = i(k.at, p, g), v.left += o[0], v.top += o[1], this.each(function() {
               ...
               'right' === e.my[0] ? I.left -= u : 'center' === e.my[0] && (I.left -= u / 2),
                   ...
                   n = {marginLeft: f, marginTop: _}, t.each(['left', 'top'], function(i, s) {
                     t.ui.position[x[i]] && t.ui.position[x[i]][s](I, {
                       ...
                       elem: c
                         ...
                         var i = m.left - I.left, s = i + p - u, n = m.top - I.top, o = n + g - d,
                             h = {
    ...
    t.ui.position = {
      ...
      flip: {
        left: function(t, e) {
          var i, s,
              n = e.within, o = n.offset.left + n.scrollLeft, a = n.width,
        ...
        top: function(t, e) {
          var i, s,
              n = e.within, o = n.offset.top + n.scrollTop, a = n.height,
  ...
  _refreshValue: function() {
    ...
    this.valueDiv.toggle(this.indeterminate || e > this.min)
        ...
        (this.element.removeAttr('aria-valuenow'),
         this.overlayDiv ||
             (this.overlayDiv =
                  t('<div class=\'ui-progressbar-overlay\'></div>').appendTo(this.valueDiv))) :
...
t.widget('ui.slider', t.ui.mouse, {
  ...
  _mouseCapture: function(e) {
    ...
    return u.disabled ?
        ...
        (this.elementSize = {width: this.element.outerWidth(), height: this.element.outerHeight()},
         this.elementOffset = this.element.offset(), i = {x: e.pageX, y: e.pageY},
         ...
         r === !1 ?
             !1 :
             (this._mouseSliding = !0, this._handleIndex = a, o.addClass('ui-state-active').focus(),
              h = o.offset(), l = !t(e.target).parents().addBack().is('.ui-slider-handle'),
  ...
  values: function(e, i) {
    ...
    if (arguments.length > 1)
      return this.options.values[e] = this._trimAlignValue(i), this._refreshValue(),
             this._change(null, e), undefined;
  ...
  _setOption: function(e, i) {
    ...
    switch ('range' === e && this.options.range === !0 &&
                ('min' === i ? (this.options.value = this._values(0), this.options.values = null) :
                               'max' === i &&
          ...
          h.options.range === !0 &&
              ('horizontal' === h.orientation ?
                   ...
                   (0 === s &&
                    ...
                    1 === s &&
                        h.range[l ? 'animate' : 'css'](
                            {height: i - e + '%'}, {queue: !1, duration: r.animate}))),
          e = i
        }) :
    ...
    keydown: function(i) {
      ...
      switch (i.keyCode) {
        ...
        case t.ui.keyCode.LEFT:
          if (i.preventDefault(),
              !this._keySliding &&
                  (this._keySliding = !0, t(i.target).addClass('ui-state-active'),
...
t.widget('ui.spinner', {
  ...
  _create: function() {
    this._setOption('max', this.options.max), this._setOption('min', this.options.min),
        ...
        this._on(this._events), this._refresh(), this._on(this.window, {
          beforeunload: function() {
            this.element.removeAttr('autocomplete')
          }
        })
  ...
  _draw: function() {
    ...
    this.element.attr('role', 'spinbutton'),
        this.buttons =
            t.find('.ui-spinner-button').attr('tabIndex', -1).button().removeClass('ui-corner-all'),
  ...
  _increment: function(e) {
    ...
    return i ?
        t.isFunction(i) ? i(e) : Math.floor(e * e * e / 5e4 - e * e / 500 + 17 * e / 200 + 1) :
        1
  },
  _precision: function() {
...
t.widget('ui.tabs', {
  ...
  _tabKeydown: function(i) {
    ...
    if (!this._handlePageNav(i)) {
      ...
      i.preventDefault(), clearTimeout(this.activating), n = this._focusNextTab(n, o),
                                                         i.ctrlKey ||
          (s.attr('aria-selected', 'false'), this.tabs.eq(n).attr('aria-selected', 'true'),
  ...
  _setOption: function(t, i) {
    return 'active' === t ?
        ...
        (this._super(t, i),
         ...
         'event' === t && this._setupEvents(i), 'heightStyle' === t && this._setupHeightStyle(i), e)
  },
  _tabId: function(t) {
  ...
  _processTabs: function() {
    ...
    this.panels = t(), this.anchors.each(function(i, n) {
      ...
      s(n) ? (o = n.hash, a = e.element.find(e._sanitizeSelector(o))) :
          ...
          a.length && (e.panels = e.panels.add(a)), c && l.data('ui-tabs-aria-controls', c),
  ...
  _eventHandler: function(e) {
    ...
    e.preventDefault(),
        o.hasClass('ui-state-disabled') || o.hasClass('ui-tabs-loading') || this.running ||
        a && !i.collapsible || this._trigger('beforeActivate', e, c) === !1 ||
  ...
  enable: function(i) {
    ...
    s !== !1 &&
        (i === e ? s = !1 : (i = this._getIndex(i), s = t.isArray(s) ? t.map(s, function(t) {
           return t !== i ? t : null
             ...
             (o.addClass('ui-tabs-loading'), r.attr('aria-busy', 'true'),
              this.xhr
                  ...
                  .complete(function(t, e) {
                    setTimeout(function() {
                      'abort' === e && n.panels.stop(!1, !0), o.removeClass('ui-tabs-loading'),
...
function i(e) {
  ...
  -1 !== n && s.splice(n, 1), e.removeData('ui-tooltip-id'),
      s = t.trim(s.join(' ')), s ? e.attr('aria-describedby', s) : e.removeAttr('aria-describedby')
}
var s = 0;
t.widget('ui.tooltip', {
  version: '1.10.4',
  ...
  _open: function(i, s, n) {
    ...
    if (n) {
      ...
      s.is('[title]') &&
          ...
          i && 'focusin' !== i.type || (r.focusout = 'close'), this._on(!0, s, r)
    }
  },
  close: function(e) {
    ...
    this.closing ||
        (clearInterval(this.delayedShow),
         n.data('ui-tooltip-title') && n.attr('title', n.data('ui-tooltip-title')), i(n),
         o.stop(!0),
         this._hide(
             o, this.options.hide,
             function() {
